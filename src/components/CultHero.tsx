...
const CultHero = () => {
  ...
  // Create stars effect on mouse move
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      setTimeout(() => {
        ...
        star.style.transform = `translate(${(Math.random() - 0.5) * 50}px, ${(Math.random() - 0.5) * 50}px)`;
      }, 10);
  ...
  useEffect(() => {
    ...
    const timer2 = setTimeout(() => setShowSymbols(true), 1800);
    const timer3 = setTimeout(() => setRevealText(true), 2500);
    ...
    <div ref={containerRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className={`absolute h-80 w-80 transition-all duration-1500 ease-out ${
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-20 w-20 rounded-full bg-black/90 border border-primary flex items-center justify-center">
          <Terminal className="h-10 w-10 text-primary animate-pulse-subtle" />
        </div>
        ...
        <div className="absolute h-full w-full animate-[spin_25s_linear_infinite_reverse]">
        ...
        <div className="absolute h-full w-full animate-[spin_20s_linear_infinite]" style={{ animationDelay: '-7s' }}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 flex flex-col items-center text-center max-w-3xl">
        <div className="space-y-8">
          ...
          <h1 className={`text-4xl sm:text-6xl font-bold leading-tight tracking-tighter mb-4 transition-all duration-1000 ${
            ...
            <div className="glitch-text relative" data-text="PROMPT OR DIE">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_auto] animate-gradient-shift">PROMPT OR DIE</span>
            </div>
          </h1>
          
          {/* Enigmatic subtitle with text reveal animation */}
          <p className={`text-xl text-muted-foreground max-w-xl mx-auto transition-all duration-1000 delay-300 ${
          ...
          <div className={`flex items-center justify-center gap-4 my-8 transition-all duration-1000 delay-700 ${
            ...
            <Terminal className="h-5 w-5 text-primary rotate-45" />
            <div className="h-px w-16 bg-gradient-to-r from-transparent via-primary to-transparent"></div>
          </div>
        ...
        <div className={`mt-24 grid grid-cols-5 gap-6 sm:gap-10 transition-all duration-1000 delay-1000 ${
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="h-px w-5 bg-primary/40"></div>
          </div>
          <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-2">
            <Flame className="h-7 w-7 text-primary/80 animate-float-symbol" style={{animationDelay: '1s'}} />
            <div className="h-px w-5 bg-primary/40"></div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Terminal className="h-7 w-7 text-primary/80 animate-float-symbol" style={{animationDelay: '1.5s'}} />
            <div className="h-px w-5 bg-primary/40"></div>
          </div>
          <div className="flex flex-col items-center gap-2">
